...
{	
	...
	if ( UI.InterfaceMode == MODE_DESIGN )	
	{
		...
		{	
			...
			case ITM_DELETE: return DELETES;
	...
	else	
	{
		...
		{	
			...
			case ITM_OMOR: return OMOR;
			case ITM_AMOR: return AMOR;
			case ITM_RMOR: return RMOR;
			case ITM_SELL: return SELL;
			case ITM_NEWGAME: return NEWGAME;
			case ITM_SWITCH_TO_DESIGN_MODE: return TO_DESIGN_MODE;		
				case ITM_EXITT: return EXITT;
...
CellPosition Input::GetCellClicked() const
{
	...
	if ( UI.InterfaceMode == MODE_DESIGN ||UI.InterfaceMode == MODE_PLAY )	
	{
		...
		cellPos.SetVCell((int)y/UI.CellHeight);	
		cellPos.SetHCell((int)x/UI.CellWidth);
